...
_SCHEMA: list[TableInfo] = [
    TableInfo(
        ...
        columns=[
            ...
            ColumnInfo(name="type", type="text", description="Account type: bank, cash, credit_card, wallet, investment, loan"),
    ...
    TableInfo(
        name="transactions",
        description="All financial transactions (expense, income, transfer)",
        columns=[
            ColumnInfo(name="id", type="uuid", description="Primary key"),
            ColumnInfo(name="user_id", type="uuid", description="Owner user", foreign_key="users.id"),
            ColumnInfo(name="type", type="text", description="Transaction type: expense, income, transfer"),
            ...
            ColumnInfo(name="created_at", type="timestamptz", description="Creation timestamp"),
            ColumnInfo(name="transacted_at", type="timestamptz", description="Transaction date/time"),
    ...
    TableInfo(
        name="splits",
        description="Split expense tracking — one split per shared expense",
        columns=[
            ColumnInfo(name="id", type="uuid", description="Primary key"),
            ColumnInfo(name="user_id", type="uuid", description="Owner user", foreign_key="users.id"),
            ColumnInfo(name="expense_transaction_id", type="uuid", description="The transaction being split", foreign_key="transactions.id"),
    ...
    TableInfo(
        ...
        columns=[
            ...
            ColumnInfo(name="settled_at", type="timestamptz", description="When this share was settled"),
            ColumnInfo(name="settlement_transaction_id", type="uuid", description="Settlement transaction", foreign_key="transactions.id"),
            ColumnInfo(name="forgiven_at", type="timestamptz", description="When this share was forgiven"),
        ],
    ),
    TableInfo(
        name="budgets",
        description="Budget definitions — one-time or recurring",
        columns=[
            ColumnInfo(name="id", type="uuid", description="Primary key"),
            ColumnInfo(name="user_id", type="uuid", description="Owner user", foreign_key="users.id"),
            ...
            ColumnInfo(name="period", type="text", description="Period: monthly, weekly, yearly, custom"),
            ...
            ColumnInfo(name="type", type="text", description="Budget type: one_time, recurring"),
